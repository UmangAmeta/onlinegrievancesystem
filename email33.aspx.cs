...
namespace cms
{
    public partial class email33 : System.Web.UI.Page
    {
        ...
        try
        {
            ...
            if (dr.HasRows)
            {
                ...
                strBody.Append("<a href=http://localhost:34412/ResetPassword.aspx?EmailId=" + txtEmailId.Text + "&uName=" + txtUserName.Text + "&uCode=" + uniqueCode + ">Click here to change your password</a>");
